...
- Clicking on any entry will send you to [Transaction details page](https://docs.alleslabs.com/user/general/transaction/detail-page)
...
- Clicking on any entry will send you to [Block details page](https://docs.alleslabs.com/user/general/block/detail-page)
...
Displays the latest smart contracts codes deployed on the network. You can filter the codes by the instantiated permission. See more about instantiated permission in [**Code Information Section.**](https://docs.alleslabs.com/user/cosmwasm/code/detail-page#code-information-section)
...
- Action Buttons
- Clicking on any entry will send you to [Code details page](https://docs.alleslabs.com/user/cosmwasm/code/detail-page)
...
- **Save Contract** (Button): Save this contract to "Saved Contract" or other Contract List for easy access when you need to use it later. See [Save Contracts](https://docs.alleslabs.com/user/cosmwasm/contract/organize#saving-contract-for-later-use)
- Clicking on any entry will send you to [**Contract details** Page](https://docs.alleslabs.com/user/cosmwasm/contract/detail-page)
...
- Clicking on any entry will send you to [Proposal details page](https://docs.alleslabs.com/user/general/proposal/detail-page)
...
- Clicking on any entry will send you to [Pool details page](https://docs.alleslabs.com/user/cosmwasm/osmosis/pool-detail)
