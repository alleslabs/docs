...
1. In case you have JSON Schema for the code, you can attach it through “Attach” button. Otherwise, you can click “Skip and proceed to instantiate” as well. See more about [JSON Schema](https://docs.alleslabs.com/user/cosmwasm/code/attach-json-schema)
