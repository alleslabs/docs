...
You can save this off-chain information on Celatone, and it can be edited later for updates or corrections. See [Save Contracts](https://docs.alleslabs.com/user/cosmwasm/contract/organize#saving-contract-for-later-use)
