...
- **Save Code:** You can save code for later use. See more in Organize Code through Celatone
...
- **JSON Schema**: An option to attach a JSON schema to the code for clarity on input fields and data types. See Attach JSON Schema
