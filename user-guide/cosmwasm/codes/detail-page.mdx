...
- **Save Code:** You can save code for later use. See more in [Organize Code through Celatone](https://docs.alleslabs.com/developers/cosmwasm/codes/organize)
...
- **JSON Schema**: An option to attach a JSON schema to the code for clarity on input fields and data types. See [Attach JSON Schema](https://docs.alleslabs.com/developers/cosmwasm/codes/attach-json-schema)
...
<Card title="Learn more about JSON schema" icon="file-circle-plus" href="https://docs.alleslabs.com/developers/cosmwasm/codes/attach-json-schema">
