...
<Tabs>
  <Tab title="How to Query with JSON Input">

    <Frame>
      <img src="/images/user-docs/pages/query-input.jpg" />
    </Frame>
  ...
  <Tab title="How to Query with JSON Schema">
    ...
    <Frame>
      <img src="/images/user-docs/pages/query-schema.jpg" />
    </Frame>
  ...
  <Card title="Learn more about JSON schema" icon="file-circle-plus" href="https://docs.alleslabs.com/user-guide/cosmwasm/code/attach-json-schema">
...
<Tabs>
  <Tab title="How to Execute with JSON Input">
 
    <Frame>
      <img src="/images/user-docs/pages/execute-input.jpg" />
    </Frame>
  ...
  <Tab title="How to Execute with JSON Schema">

    <Frame>
      <img src="/images/user-docs/pages/execute-schema.jpg" />
    </Frame>
