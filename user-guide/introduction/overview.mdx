...
- Clicking on any entry will send you to [Transaction details page](https://docs.alleslabs.com/user-guide/general/transactions/detail-page)
...
- Clicking on any entry will send you to [Block details page](https://docs.alleslabs.com/user-guide/general/blocks/detail-page)
...
Displays the latest smart contracts codes deployed on the network. You can filter the codes by the instantiated permission. See more about instantiated permission in [**Code Information Section.**](https://docs.alleslabs.com/user-guide/cosmwasm/codes/detail-page#code-information-section)
...
- Action Buttons
- Clicking on any entry will send you to [Code details page](https://docs.alleslabs.com/user-guide/cosmwasm/codes/detail-page)
...
- **Save Contract** (Button): Save this contract to "Saved Contract" or other Contract List for easy access when you need to use it later. See [Save Contracts](https://docs.alleslabs.com/developers/cosmwasm/contracts/organize#saving-contract-for-later-use)
- Clicking on any entry will send you to [Contract details Page](https://docs.alleslabs.com/user-guide/cosmwasm/contracts/detail-page)
...
- Clicking on any entry will send you to [Proposal details page](https://docs.alleslabs.com/user-guide/general/proposals/detail-page)
...
- Clicking on any entry will send you to [Validator details page](https://docs.alleslabs.com/user-guide/general/validators/detail-page)
...
- Clicking on any entry will send you to [Pool details page](https://docs.alleslabs.com/user-guide/osmosis/pool-detail)
