...
<Note>
Looking for [developer docs](https://docs.alleslabs.com/development/introduction)? Read more about [Celatone technical architecture](https://docs.alleslabs.com/development/architecture/overview) or how to [deploy your own instance](https://docs.alleslabs.com/development/local-deployment/introduction) on Celatone here.
</Note>
