...
This section may also highlight the number of [NFTs](/user-guide/move/account/detail-page#nfts), [resources](/user-guide/move/account/detail-page#resources), [modules](/user-guide/move/account/detail-page#modules) and any [proposals](/user-guide/move/account/detail-page#proposals) associated with the account.
