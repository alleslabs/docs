...
- **Transactions & Histories**: A log of all transactions involving the module, including published events and related proposals. More information on [“Transaction & Histories” section](https://docs.alleslabs.com/user-guide/move/modules/detail-page#transactions-and-histories)
