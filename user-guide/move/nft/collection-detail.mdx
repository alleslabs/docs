...
- **Resource**: Display the button that allow user to view the collection as a resource. Read more about Resource at [Resource section in Account Detail Page](https://docs.alleslabs.com/user-guide/move/account/detail-page#resources)
