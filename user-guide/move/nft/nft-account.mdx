...
In addition to accessing the NFT Collection List, Collection Detail, and NFT Detail pages, users can view the NFTs associated with each account directly from the [Account Details page](https://docs.alleslabs.com/user-guide/move/account/detail-page)
...
For additional information, please refer to [NFT Detail Page](https://docs.alleslabs.com/user-guide/move/nft/detail-page)