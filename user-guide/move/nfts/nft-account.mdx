...
In addition to accessing the NFT Collection List, Collection Detail, and NFT Detail pages, users can view the NFTs associated with each account directly from the [Account Details page](https://docs.alleslabs.com/user-guide/general/accounts/detail-page#move)
