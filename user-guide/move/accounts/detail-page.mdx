...
The “NFTs” tab on the Account Details page show any NFTs owned by the user's account. For further information, please see [NFT on Account Detail](https://docs.alleslabs.com/user-guide/move/nfts/nft-account)
