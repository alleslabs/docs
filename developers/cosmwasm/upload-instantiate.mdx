...
<Frame>
  <img src="/images/user-docs/pages/upload-wasm.jpg" />
</Frame>
...
1. In case you have JSON Schema for the code, you can attach it through “Attach” button. Otherwise, you can click “Skip and proceed to instantiate” as well. See more about [JSON Schema](https://docs.alleslabs.com/developers/cosmwasm/codes/attach-json-schema)

<Note>
  Remark: If you choose a permissioned CosmWasm network, not everyone is allowed
  to store code. Consequently, you may not be able to continue beyond step 4, as
